...
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/volk-xp/Discord-quest-completer-by-Volk/build-release.yaml?branch=main&style=flat&label=build%20(release))
[![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/volk-xp/Discord-quest-completer-by-Volk/rust-check.yml?branch=main&style=flat&label=scheduled%20build%20%28every%202%20days%29)](https://github.com/volk-xp/Discord-quest-completer-by-Volk/actions/workflows/rust-check.yml?query=branch%3Amain+event%3Aschedule)
...
You can download manually pre-built release binaries on the [Releases](https://github.com/volk-xp/Discord-quest-completer-by-Volk/releases) page.
